...
Public Class frmProduct_IN
    ...
    Function Load_Item_Code()
        ...
        Try
            Sql = "select M13Part_No as [##],max(M11Part_Name) as [Item Name]  from M13BOM_Creation inner join M11Product_Item on M11Part_No=M13Part_No where M13Status='A' group by M13Part_No  "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            With cboCode
                .DataSource = M01
    ...
    Function Load_Item_Name()
        ...
        Try
            Sql = "select max(M11Part_Name) as [Item Name]  from M13BOM_Creation inner join M11Product_Item on M11Part_No=M13Part_No where M13Status='A' group by M13Part_No "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            With cboItemName
                .DataSource = M01
    ...
    Private Sub frmProduct_IN_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frmView_ProductIN.Close()
    End Sub


    Private Sub frmProduct_IN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Function Search_Records()
        ...
        Try
            Sql = "select * from T07_1Product_IN_Header inner join M03New_Location on M03Loc_Code=T07_1Loc inner join T07Production_IN on T07_1Tr_No=T07Tr_No  inner join M11Product_Item on M11Part_No=T07Item_Code where T07_1Tr_No='" & Trim(txtEntry.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            i = 0
            For Each DTRow2 As DataRow In M01.Tables(0).Rows
                cboLocation.Text = Trim(M01.Tables(0).Rows(0)("M03Loc_Name"))
                txtRemark.Text = Trim(M01.Tables(0).Rows(0)("T07_1Remark"))
                Dim newRow As DataRow = c_dataCustomer1.NewRow
                newRow("Item Code") = Trim(M01.Tables(0).Rows(i)("T07Item_Code"))
                newRow("Item Name") = Trim(M01.Tables(0).Rows(i)("M11Part_Name"))
                Value = Trim(M01.Tables(0).Rows(i)("T08Cost"))
                ...
                Value = CDbl(M01.Tables(0).Rows(i)("T07Qty")) * CDbl(M01.Tables(0).Rows(i)("T08Cost"))
                _st = (vALUE.ToString("0,0.00", System.Globalization.CultureInfo.InvariantCulture))
                _st = (String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0:0,0.00}", vALUE))
                newRow("Total") = _st
    ...
    Function Load_EntryNo()
        ...
        Try
            Sql = "select * from P01Parameter where  P01Code='PI'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                If M01.Tables(0).Rows(0)("P01No") >= 1 And M01.Tables(0).Rows(0)("P01No") < 10 Then
                    txtEntry.Text = "PR/IN-00" & M01.Tables(0).Rows(0)("P01No")
                ElseIf M01.Tables(0).Rows(0)("P01No") >= 10 And M01.Tables(0).Rows(0)("P01No") < 100 Then
                    txtEntry.Text = "PR/IN-0" & M01.Tables(0).Rows(0)("P01No")
                Else
                    txtEntry.Text = "PR/IN-" & M01.Tables(0).Rows(0)("P01No")
                End If
            End If
    ...
    Function Search_Item() As Boolean
        ...
        Dim i As Integer
        Try
            Sql = "SELECT M11Part_Name FROM M11Product_Item WHERE M11Part_No='" & Trim(cboCode.Text) & "' AND M11Status='A' and M11Type='PRODUCT ITEM' "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                Search_Item = True
    ...
    Function Save_Date()
        ...
        Try
            ...
            Call Calculation_Sub()
            '===================================================================================================
            nvcFieldList1 = "SELECT * FROM T07_1Product_IN_Header where T07_1Tr_No='" & Trim(txtEntry.Text) & "'"
            MB51 = DBEngin.ExecuteDataset(connection, transaction, nvcFieldList1)
            If isValidDataset(MB51) Then
                MsgBox("This Product IN alrady exsist", MsgBoxStyle.Information, "Information ........")
                connection.Close()
                Exit Function
            Else
                ...
                nvcFieldList1 = "update P01Parameter set P01No=P01No+ " & 1 & " where P01Code='PI' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into T07_1Product_IN_Header(T07_1Tr_No,T07_1Loc,T07_1Date,T07_1Remark,T07_1Status)" & _
                ...
                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                              " values('PRODUCT_IN', 'SAVE','" & _GET_TIME & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                For Each uRow As UltraGridRow In UltraGrid1.Rows
                    If IsNumeric(Trim(UltraGrid1.Rows(i).Cells(3).Text)) Then
                        ...
                        nvcFieldList1 = "Insert Into T07Production_IN(T07Tr_No,T07Item_Code,T08Cost,T07Qty,T07Status)" & _
                        ...
                        If isValidDataset(M01) Then
                            If Trim(M01.Tables(0).Rows(0)("M11Type")) = "PRODUCT ITEM" Then
                                nvcFieldList1 = "Insert Into S01Stock_Product_Items(S01Part_No,S01Loc_Code,S01Date,S01Tr_Type,S01Ref_No,S01Qty,S01Status)" & _
                                                                               " values('" & Trim(UltraGrid1.Rows(i).Cells(0).Text) & "', '" & _Loccode & "','" & _GETDATE & "','PRODUCT_IN','" & Trim(txtEntry.Text) & "','" & (UltraGrid1.Rows(i).Cells(3).Text) & "','A')"
                                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                transaction.Commit()
                connection.Close()
                A = MsgBox("Are you sure you want to print Product IN report", MsgBoxStyle.Information + MsgBoxStyle.YesNo, "Informtion ........")
                If A = vbYes Then
                    A = ConfigurationManager.AppSettings("ReportPath") + "\ProductIN.rpt"
                    B.Load(A.ToString)
                    ...
                    frmReport.CrystalReportViewer1.SelectionFormula = "{T07_1Product_IN_Header.T07_1Tr_No} ='" & txtEntry.Text & "'"
                    frmReport.Refresh()
    ...
    Function Edit_Save()
        ...
        Try
            ...
            If isValidDataset(MB51) Then
                ...
                nvcFieldList1 = "UPDATE T07_1Product_IN_Header SET T07_1Loc='" & _Loccode & "',T07_1Date='" & txtDate.Text & "',T07_1Remark='" & txtRemark.Text & "' WHERE T07_1Tr_No='" & Trim(txtEntry.Text) & "' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                              " values('PRODUCT_IN', 'EDIT','" & _GET_TIME & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "DELETE FROM T07Production_IN WHERE T07Tr_No='" & Trim(txtEntry.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If A = vbYes Then
                ...
                nvcFieldList1 = "UPDATE T07_1Product_IN_Header SET T07_1Status='DELETE' WHERE T07_1Tr_No='" & Trim(txtEntry.Text) & "' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE T07Production_IN SET T07Status='DELETE' WHERE T07Tr_No='" & Trim(txtEntry.Text) & "' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                        " values('PRODUCT_IN', 'DELETE','" & _GET_TIME & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
