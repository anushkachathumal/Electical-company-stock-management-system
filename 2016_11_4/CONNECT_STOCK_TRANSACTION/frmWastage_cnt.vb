...
Public Class frmWastage_cnt
    ...
    Private Sub frmWastage_cnt_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frmview_Wastage.Close()
    End Sub

    Private Sub frmWastage_cnt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Function Search_Records()
        ...
        Try
            Sql = "select * from T10Wastage_Header inner join M03New_Location on M03Loc_Code=T10Loc inner join T11Wastage_Flutter on T11Tr_No=T10Tr_No  inner join M11Product_Item on M11Part_No=T11Item_Code where T10Tr_No='" & Trim(txtEntry.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            i = 0
            For Each DTRow2 As DataRow In M01.Tables(0).Rows
                cboLocation.Text = Trim(M01.Tables(0).Rows(0)("M03Loc_Name"))
                txtRemark.Text = Trim(M01.Tables(0).Rows(0)("T10Remark"))
                Dim newRow As DataRow = c_dataCustomer1.NewRow
                newRow("Item Code") = Trim(M01.Tables(0).Rows(i)("T11Item_Code"))
                newRow("Item Name") = Trim(M01.Tables(0).Rows(i)("M11Part_Name"))
                Value = Trim(M01.Tables(0).Rows(i)("T11Cost"))
                ...
                newRow("Qty") = Trim(M01.Tables(0).Rows(i)("T11Qty"))
          
                Value = CDbl(M01.Tables(0).Rows(i)("T11Qty")) * CDbl(M01.Tables(0).Rows(i)("T11Cost"))
                _st = (vALUE.ToString("0,0.00", System.Globalization.CultureInfo.InvariantCulture))
                _st = (String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0:0,0.00}", vALUE))
                newRow("Total") = _st
    ...
    Function Load_EntryNo()
        ...
        Try
            Sql = "select * from P01Parameter where  P01Code='WST'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                If M01.Tables(0).Rows(0)("P01No") >= 1 And M01.Tables(0).Rows(0)("P01No") < 10 Then
                    txtEntry.Text = "WST-00" & M01.Tables(0).Rows(0)("P01No")
                ElseIf M01.Tables(0).Rows(0)("P01No") >= 10 And M01.Tables(0).Rows(0)("P01No") < 100 Then
                    txtEntry.Text = "WST-0" & M01.Tables(0).Rows(0)("P01No")
                Else
                    txtEntry.Text = "WST-" & M01.Tables(0).Rows(0)("P01No")
                End If
            End If
    ...
    Function Search_Item() As Boolean
        ...
        Dim i As Integer
        Try
            Sql = "SELECT M11Part_Name FROM M11Product_Item WHERE M11Part_No='" & Trim(cboCode.Text) & "' AND M11Status='A'  "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                Search_Item = True
    ...
    Function Save_Date()
        ...
        Try
            ...
            'End If
            '===================================================================================================
            nvcFieldList1 = "SELECT * FROM T10Wastage_Header where T10Tr_No='" & Trim(txtEntry.Text) & "'"
            MB51 = DBEngin.ExecuteDataset(connection, transaction, nvcFieldList1)
            If isValidDataset(MB51) Then
                MsgBox("This Wastage note alrady exsist", MsgBoxStyle.Information, "Information ........")
                connection.Close()
                Exit Function
            Else
                ...
                nvcFieldList1 = "update P01Parameter set P01No=P01No+ " & 1 & " where P01Code='WST' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into T10Wastage_Header(T10Tr_No,T10Loc,T10Date,T10Remark,T10Status)" & _
                ...
                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                              " values('WASTAGE', 'SAVE','" & _GET_TIME & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                For Each uRow As UltraGridRow In UltraGrid1.Rows
                    If IsNumeric(Trim(UltraGrid1.Rows(i).Cells(3).Text)) Then
                        ...
                        nvcFieldList1 = "Insert Into T11Wastage_Flutter(T11Tr_No,T11Item_Code,T11Cost,T11Qty,T11Status)" & _
                ...
                transaction.Commit()
                connection.Close()
                A = MsgBox("Are you sure you want to print wastage report", MsgBoxStyle.Information + MsgBoxStyle.YesNo, "Informtion ........")
                If A = vbYes Then
                    ...
                    frmReport.CrystalReportViewer1.SelectionFormula = "{T10Wastage_Header.T10Tr_No}='" & txtEntry.Text & "'"
                    frmReport.Refresh()
    ...
    Function Edit_Save()
        ...
        Try
            ...
            If isValidDataset(MB51) Then
                ...
                nvcFieldList1 = "UPDATE T10Wastage_Header SET T10Loc='" & _Loccode & "',T10Date='" & txtDate.Text & "',T10Remark='" & txtRemark.Text & "' WHERE T10Tr_No='" & Trim(txtEntry.Text) & "' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                              " values('WASTAGE', 'EDIT','" & _GET_TIME & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "DELETE FROM T11Wastage_Flutter WHERE T11Tr_No='" & Trim(txtEntry.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If A = vbYes Then
                ...
                nvcFieldList1 = "UPDATE T10Wastage_Header SET T10Status='DELETE' WHERE T10Tr_No='" & Trim(txtEntry.Text) & "' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE T11Wastage_Flutter SET T11Status='DELETE' WHERE T11Tr_No='" & Trim(txtEntry.Text) & "' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                        " values('WASTAGE', 'DELETE','" & _GET_TIME & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
