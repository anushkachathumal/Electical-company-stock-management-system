...
Public Class frmStockBalance_Product
    ...
    Function Search_Itemcode() As Boolean
        ...
        Try
            ...
            If isValidDataset(M01) Then
                'current balance
                Sql = "SELECT sum(S01Qty) as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A'  AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' group by S01Part_No"
                ...
                'LAST O/B
                Sql = "SELECT S01Date,S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='OB' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "'"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then
                ...
                '=======================================================================
                'GRN
                Sql = "SELECT SUM(S01Qty) as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='GRN' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' GROUP BY S01Part_No,S01Tr_Type,S01Loc_Code"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then
                ...
                '=======================================================================
                'STOCK IN
                Sql = "SELECT SUM(S01Qty)as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='STOCK IN' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' GROUP BY S01Part_No,S01Tr_Type,S01Loc_Code"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then

                    txtStock_IN.Text = CInt(m02.Tables(0).Rows(0)("S01Qty"))
                Else
                ...
                '=================================================================================================================================================
                'WASTAGE
                Sql = "SELECT SUM(S01Qty) as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='WST' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' GROUP BY S01Part_No,S01Tr_Type,S01Loc_Code"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then
                ...
                '=====================================================================================================================
                'LOADING
                Sql = "SELECT SUM(S01Qty) as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='LOADING' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' GROUP BY S01Part_No,S01Tr_Type,S01Loc_Code"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then
                ...
                '=====================================================================================================================
                'UNLOADING
                Sql = "SELECT SUM(S01Qty) as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='UNLOADING' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' GROUP BY S01Part_No,S01Tr_Type,S01Loc_Code"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then
                ...
                '=====================================================================================================================
                'TRANSFER
                Sql = "SELECT SUM(S01Qty) as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='TR' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' GROUP BY S01Part_No,S01Tr_Type,S01Loc_Code"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then

                    txtTransfer.Text = CInt(m02.Tables(0).Rows(0)("S01Qty"))
                Else
                ...
                '=====================================================================================================================
                'Market Return
                Sql = "SELECT SUM(S01Qty)as S01Qty FROM S01Stock_Product_Items WHERE S01Part_No='" & Trim(cboCode.Text) & "' AND S01Status='A' AND S01Tr_Type='MK_RETURN' AND S01Loc_Code='" & Trim(M01.Tables(0).Rows(0)("M03Loc_Code")) & "' GROUP BY S01Part_No,S01Tr_Type,S01Loc_Code"
                m02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(m02) Then
    ...
    Function Save_Data()
        ...
        Try
            ...
            For Each uRow As UltraGridRow In UltraGrid2.Rows
                ...
                nvcFieldList1 = "UPDATE  S01Stock_Product_Items SET S01Status='CLOSE' where S01Part_No='" & Trim(UltraGrid2.Rows(i).Cells(0).Text) & "' AND S01Loc_Code='" & _LocCode & "'"
